...
const AdminNotFoundLogs = lazyWithRetry(() => import('../pages/AdminNotFoundLogs'));
...
const LoadingFallback = () => (
  <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-brand-800 via-brand-600 to-brand-500">
    <div className="flex flex-col items-center gap-6 animate-fade-in">
      <img src="/imgs/FrimousseLogo.webp" alt="Les Frimousses" className="w-20 h-20 object-contain animate-spin-slow mb-2" />
      ...
      <Suspense fallback={<LoadingFallback />}>
        <Routes>
          ...
          <Route element={<ProtectedLayout />}>
            ...
            <Route path="/admin/not-found-logs" element={<AdminNotFoundLogs />} />
