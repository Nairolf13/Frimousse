...
export default function GuideAddChildPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col overflow-x-hidden bg-white p-0 m-0">
      <Helmet>
        <title>Ajouter un enfant | Guide Frimousse</title>
        <meta name="description" content="Tutoriel pour ajouter un enfant dans Frimousse : formulaire, champs obligatoires, gestion des groupes et informations parentales." />
      </Helmet>
      ...
      <main className="flex-1 w-full">
        <section className="w-full py-12 px-6 bg-white border-b border-gray-100">
          <div className="max-w-3xl mx-auto text-left">
            ...
            <h1 className="text-3xl font-bold text-green-700 mb-6">Ajouter un enfant</h1>
            ...
            <div className="mt-8 text-gray-600 text-sm">Astuce : Utilisez les groupes pour organiser les enfants par tranche d'âge.</div>
          </div>
        </section>
