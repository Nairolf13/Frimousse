...
import ConfirmDialog from '../components/ConfirmDialog';
        ...
        export default function LandingPage() {
          ...
          <div className="min-h-screen w-full flex flex-col overflow-x-hidden bg-[#f7f4d7] p-0 m-0 relative pb-16 sm:pb-0">
              ...
              <section className="w-full pt-16 pb-4 px-4 bg-gradient-to-r from-[#a9ddf2] to-[#f7f4d7]">
                <div className="max-w-6xl mx-auto">
                  ...
                  <div className="flex justify-center mt-12 mb-0">
                    <div className="w-full max-w-3xl flex gap-8 items-end">
                      <div className="bg-gradient-to-br from-white/70 to-white/60 backdrop-blur-md rounded-3xl shadow-2xl border border-white/30 p-6 md:p-8 flex flex-col items-center justify-center gap-3 md:gap-4 flex-1 min-w-0 border-[#fcdcdf] hover:scale-105 transition-transform">
                        <span className="inline-block bg-[white] rounded-full shadow px-4 py-2 text-[#0b5566] font-bold text-lg">{childrenCount !== null ? childrenCount : '...'}</span>
                        <span className="text-[#0b5566] font-semibold text-base">Familles<br />inscrites</span>
                      </div>

                      <div className="bg-gradient-to-br from-white/70 to-white/60 backdrop-blur-md rounded-3xl shadow-2xl border border-white/30 p-6 md:p-8 flex flex-col items-center justify-center gap-3 md:gap-4 flex-1 min-w-0 border-[#fcdcdf] hover:scale-105 transition-transform">
                        <span className="inline-block bg-white rounded-full shadow px-4 py-2 text-[#0b5566] font-bold text-lg">{adminCount !== null ? adminCount : '...'}</span>
                        <span className="text-[#0b5566] font-semibold text-base">Associations <br />suivi</span>
                      </div>

                      <div className="bg-gradient-to-br from-white/70 to-white/60 backdrop-blur-md rounded-3xl shadow-2xl border border-white/30 p-6 md:p-8 flex flex-col items-center justify-center gap-3 md:gap-4 flex-1 min-w-0 border-[#fcdcdf] hover:scale-105 transition-transform">
                        <span className="inline-block bg_white rounded-full shadow px-4 py-2 text-[#0b5566] font-bold text-lg">99%</span>
              ...
              <section className="w-full bg-gradient-to-r from-[#a9ddf2] to-[#f7f4d7] py-12 px-6">
                <div className="max-w-3xl mx-auto flex flex-col items-center">
                  <div className="w-full max-w-3xl bg-gradient-to-br from-white/70 to-white/60 backdrop-blur-md rounded-3xl shadow-2xl border border-white/30 p-6 md:p-8 flex flex-col gap-8 items-center">
          ...
          <section className="w-full py-16 px-6 bg-gradient-to-r from-[#a9ddf2] to-[#f7f4d7]">
                <div className="max-w-6xl mx-auto">
                  ...
                  <div className="relative mt-8 px-4 md:px-12">
                    {/* Navigation (anchored to the review card itself) - moved inside the card below */}
                        ...
                        <div className="relative">
                          <div key={currentReview!.id} className="transform transition duration-500 ease-in-out">
                            <div className="bg-gradient-to-br from-white/70 to-white/60 backdrop-blur-md rounded-3xl shadow-2xl border border-white/30 p-4 md:p-8 relative">
                              {/* Left nav (anchored to card) */}
                              <div className="absolute -left-[56px] md:-left-[72px] top-1/2 -translate-y-1/2 z-20 flex items-center">
                                <button
                              ...
                              {/* Right nav (anchored to card) */}
                              <div className="absolute -right-[56px] md:-right-[72px] top-1/2 -translate-y-1/2 z-20 flex items-center">
                                <button
                                  aria-label="Suivant"
                ...
                <div className="max-w-3xl mx-auto text-center">
                  <div className="mx-auto max-w-3xl bg-gradient-to-br from-white/70 to-white/60 backdrop-blur-md rounded-3xl shadow-2xl border border-white/30 p-6 md:p-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#0b5566] mb-4">Essayez Frimousse gratuitement dès aujourd’hui</h2>
                    <p className="text-[#08323a] mb-6 text-lg">Rejoignez des dizaines d’associations et de familles déjà convaincues. Inscription rapide, sans engagement, accompagnement personnalisé.</p>
                    <a href="/register" className="bg-[#0b5566] !text-white rounded-full px-8 py-3 font-bold text-lg shadow hover:opacity-95 transition inline-block">Créer mon compte gratuit</a>
                  </div>
                </div>
              </section>
