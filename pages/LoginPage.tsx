...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Clear client caches and unregister service worker before navigating
      try {
        if ('caches' in window) {
        ...
        console.warn('Failed to clear caches on login', e);
      }
      try {
        ...
        console.warn('Failed to unregister service worker on login', e);
      }
