...
const SOCIAL_LINKS = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/lesfrimousses13/',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61577468283486',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/groups/17963103/',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      <footer className="bg-brand-800 text-white py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img loading="lazy" src="/imgs/ChatGPT-Image-4-mars-2026_-20_32_24-removebg-preview.webp" alt="Logo" className="w-8 h-8 object-contain" />
          ...
          <div className="flex items-center gap-3">
            {SOCIAL_LINKS.map(s => (
              <a key={s.name} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.name} className="text-white/50 hover:text-white transition-colors">
                {s.icon}
              </a>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <img loading="lazy" src="/imgs/ChatGPT-Image-4-mars-2026_-20_32_24-removebg-preview.webp" alt="Logo" className="w-10 h-10 object-contain" />
