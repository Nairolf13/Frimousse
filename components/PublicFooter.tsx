      ...
      <footer className="bg-brand-800 text-white py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img loading="lazy" src="/imgs/FrimousseLogo.webp" alt="Logo" className="w-8 h-8 object-contain" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <img loading="lazy" src="/imgs/FrimousseLogo.webp" alt="Logo" className="w-10 h-10 object-contain" />
